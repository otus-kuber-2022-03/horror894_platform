...
def mysql_on_create(body, spec, patch, **kwargs):
    ...
    try:
        ...
        patch.status['describe'] = 'Restore job created'
    ...
    return {'Message': "The operator has processed the creation of the object"}

@kopf.on.field('otus.homework', 'v1', 'mysqls', field='spec.password')
def update_password(old, new, body, namespace, patch, logger, **kwargs):
    ...
    try:
        ...
        patch.status['describe'] = 'Unsuccessful password change'
        pass

    return {'info': "Job for change the password was successfully created"}
...
def delete_object_make_backup(body, **kwargs):
    ...
    api_c = kubernetes.client.CoreV1Api()
    api_c.delete_persistent_volume(persistent_volume['metadata']['name'])
